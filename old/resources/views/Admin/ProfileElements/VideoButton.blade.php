...
<div class="dt-buttons flex-wrap"style="display:flex;">
    ...
    <button  data-type="active" class="activeAll4 btn btn-light-primary me-3">
        <i class="bi bi-unlock fs-2x"></i>
    </button>
    <button   data-type="inactive" class="activeAll4 btn btn-light-danger me-3 font-weight-bolder">
...
<script type="text/javascript">
    ...
    $("#delete4").on("click", function () {
        var dataList = [];
        $("#users_table4 input:checkbox:checked").each(function (index) {
