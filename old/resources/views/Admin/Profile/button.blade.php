                                ...
                                <div class="w-100">
                                    ...
                                    <div class="row mb-10">
                                        ...
                                        <div class="col-md-6 d-flex flex-column mb-7 fv-row">
                                            ...
                                            <!--end::Label-->
                                            <input type="text" readonly class="form-control form-control-solid" placeholder=""  value="https://tapycard.com/P" name="card_name" value="Max Doe" />
                                        </div>
                                        <!--end::Input group-->
                                        <!--begin::Input group-->
                                        <div class="col-md-6 d-flex flex-column mb-7 fv-row">
                                            ...
                                            <div class="position-relative">
                                                <!--begin::Input-->
                                                <input type="text" required class="form-control form-control-solid" placeholder="Enter Profile Url" name="profile_url" value="" />
                                                <!--end::Input-->
                                                <!--begin::Card logos-->
                                                <!--end::Card logos-->
                                            </div>
                                    ...
                                    <div class="d-flex flex-column mb-7 fv-row">
                                        ...
                                        <!--end::Label-->
                                        <select required id="user_id" class="select2 form-control form-control-solid"  name="user_id"  >
                                            <option value="{{Auth::guard('web')->id()}}">Company Profile</option>
                                             @foreach(\App\Models\User::where('company_id',Auth::guard('web')->id())->get() as $user)
                                                <option value="{{$user->id}}">{{$user->name}}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                ...
                                <div class="w-100">
                                    ...
                                    <div class="row mb-10">
                                        ...
                                        <div class="col-md-6 d-flex flex-column mb-7 fv-row">
                                            <!--begin::Label-->
                                            <label class="d-flex align-items-center fs-6 fw-bold form-label mb-2">
                                                <span class="">{{__('lang.ar_first_name')}}</span>
                                            </label>
                                            <!--end::Label-->
                                        ...
                                        <div class="col-md-6 d-flex flex-column mb-7 fv-row">
                                            <!--begin::Label-->
                                            <label class="d-flex align-items-center fs-6 fw-bold form-label mb-2">
                                                <span class="">{{__('lang.en_first_name')}}</span>
                                            </label>                                                <!--end::Label-->
                                            <!--begin::Input wrapper-->
                                            <div class="position-relative">
                                                <!--begin::Input-->
                                    ...
                                    <div class="row mb-10">
                                        ...
                                        <div class="col-md-6 d-flex flex-column mb-7 fv-row">
                                            <!--begin::Label-->
                                            <label class="d-flex align-items-center fs-6 fw-bold form-label mb-2">
                                                <span class="">{{__('lang.ar_last_name')}}</span>
                                            </label>
                                            <!--end::Label-->
                                        ...
                                        <div class="col-md-6 d-flex flex-column mb-7 fv-row">
                                            <!--begin::Label-->
                                            <label class="d-flex align-items-center fs-6 fw-bold form-label mb-2">
                                                <span class="">{{__('lang.en_last_name')}}</span>
                                            </label>                                                <!--end::Label-->
                                            <!--begin::Input wrapper-->
                                            <div class="position-relative">
                                                <!--begin::Input-->
                                    ...
                                    <div class="row mb-10">
                                        ...
                                        <div class="col-md-6 d-flex flex-column mb-7 fv-row">
                                            <!--begin::Label-->
                                            <label class="d-flex align-items-center fs-6 fw-bold form-label mb-2">
                                                <span class="">{{__('lang.ar_company')}}</span>
                                            </label>
                                            <!--end::Label-->
                                        ...
                                        <div class="col-md-6 d-flex flex-column mb-7 fv-row">
                                            <!--begin::Label-->
                                            <label class="d-flex align-items-center fs-6 fw-bold form-label mb-2">
                                                <span class="">{{__('lang.en_company')}}</span>
                                            </label>                                                <!--end::Label-->
                                            <!--begin::Input wrapper-->
                                            <div class="position-relative">
                                                <!--begin::Input-->
                                    ...
                                    <div class="row mb-10">
                                        ...
                                        <div class="col-md-6 d-flex flex-column mb-7 fv-row">
                                            <!--begin::Label-->
                                            <label class="d-flex align-items-center fs-6 fw-bold form-label mb-2">
                                                <span class="">{{__('lang.ar_title')}}</span>
                                            </label>
                                            <!--end::Label-->
                                        ...
                                        <div class="col-md-6 d-flex flex-column mb-7 fv-row">
                                            <!--begin::Label-->
                                            <label class="d-flex align-items-center fs-6 fw-bold form-label mb-2">
                                                <span class="">{{__('lang.en_title')}}</span>
                                            </label>                                                <!--end::Label-->
                                            <!--begin::Input wrapper-->
                                            <div class="position-relative">
                                                <!--begin::Input-->
                                    ...
                                    <div class="row mb-10">
                                        ...
                                        <div class="col-md-6 d-flex flex-column mb-7 fv-row">
                                            <!--begin::Label-->
                                            <label class="d-flex align-items-center fs-6 fw-bold form-label mb-2">
                                                <span class="">{{__('lang.ar_sub_title')}}</span>
                                            </label>
                                            <!--end::Label-->
                                        ...
                                        <div class="col-md-6 d-flex flex-column mb-7 fv-row">
                                            <!--begin::Label-->
                                            <label class="d-flex align-items-center fs-6 fw-bold form-label mb-2">
                                                <span class="">{{__('lang.en_sub_title')}}</span>
                                            </label>                                                <!--end::Label-->
                                            <!--begin::Input wrapper-->
                                            <div class="position-relative">
                                                <!--begin::Input-->
...
<script>
    ...
    @endif
    $('#user_id').on('click , change',function () {
        var id = $(this).val();
        console.log(id);
