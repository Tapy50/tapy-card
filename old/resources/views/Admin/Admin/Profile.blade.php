            ...
            <div class="card mb-5 mb-xl-10">
                ...
                <div id="kt_account_settings_profile_details" class="collapse show">
                    ...
                    <form id="kt_account_profile_details_form" action="{{url('update-Admin')}}" class="form"
                          method="post">
                    @else
                            <form id="kt_account_profile_details_form" action="{{url('updateProfile')}}" class="form"
                                  method="post">
                    @endif
                    @csrf
                    <!--begin::Card body-->
                        <div class="card-body border-top p-9">
                            ...
                            <div class="fv-row mb-7">
                                ...
                                <input type="text" name="username"
                                       class="form-control form-control-solid mb-3 mb-lg-0"
                                       placeholder="" value="{{$employee->username}}"
                                />
                                <!--end::Input-->
                            </div>
                            <!--end::Input group-->
                            <div class="fv-row mb-7">
                                ...
                                <div class="col-md-2 col-3" id="" >
                                <input type="text" name="country_code" id="txtPhone"
                                       class="form-control form-control-solid mb-3 mb-lg-0"
                                       placeholder="" value="" />
                            </div>
                                <div class="col-md-10 col-8" id="" >
