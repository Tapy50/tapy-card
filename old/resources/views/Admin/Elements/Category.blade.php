        ...
        <div class="content flex-row-fluid" id="kt_content">
            ...
            <div class="card">
                ...
                <div class="card-body pt-0">
                    ...
                    <!--begin::Table-->
                    <table class="table align-middle table-row-dashed fs-4 gy-5" id="users_tableCategory">
                        <!--begin::Table head-->
                        <thead>
                        <!--begin::Table row-->
                        ...
                        <tr class="text-start text-muted fw-bolder fs-5 text-uppercase gs-0">
                            ...
                            <th class="min-w-125px">{{__('lang.title')}}</th>
                                    <th class="min-w-125px">{{__('lang.Sub Departments')}}</th>
...
@section('script')
    ...
    <script type="text/javascript">
        $(function () {
            var table = $('#users_tableCategory').DataTable({
                processing: true,
                serverSide: true,
                autoWidth: false,
                responsive: true,
                ...
                columns: [
                    ...
                    {data: 'title', name: 'type', "searchable": true, "orderable": true},
                    {data: 'subCategory', name: 'number', "searchable": true, "orderable": true},
    ...
    <script>
        $(function () {
            ...
            $.ajax({
                url: "{{ URL::to('/add-button-Category/'.$data->id.'/'.$parent_id)}}",
                success: function (data) { $('.LinksButton8').append(data); },
                dataType: 'html'
            });
            @else
            $.ajax({
                url: "{{ URL::to('/add-button-Category',$data->id)}}",
                success: function (data) { $('.LinksButton8').append(data); },
                dataType: 'html'
            });
