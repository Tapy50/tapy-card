                        ...
                        <div class="mt-3 mb-4">
                            ...
                            @foreach($data->ElementsSocial as $social)
                                @php
                                   ...
                                   if($social->sub_type == "whatsapp") $link = "https://api.whatsapp.com/send?phone=%2B2".$social->value;
                                @endphp
...
{{--                            </li>--}}
                        ...
                        <div class="tab-content" id="pills-tabContent">
                            ...
                            <div class="tab-pane fade" id="pills-images" role="tabpanel" aria-labelledby="pills-images-tab">
                                    <iframe src="{{url('slider',$data->id)}}" width="100%" height="500"></iframe>
                            </div>
