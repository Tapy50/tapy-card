                                        ...
                                        <div class="row w-100 p-0 m-0 py-2">
                                            <div class="appointment-card">
                                                <ul>
                                                    ...
                                                    <li class="day-number"  data-date="{{$day}}">
                                                        <div class="day @if($key == 0 ) active @endif">
                                                            <p>{{\Carbon\Carbon::parse($day)->getTranslatedShortDayName()}}</p>
                                                        </div>
                                                        <div class="number">
                                                            <h2> {{\Carbon\Carbon::parse($day)->format('d')}} </h2>
                                                        </div>
                                                    </li>
                                                    @endforeach
                            ...
                            <section id="teams">
                                <div class="parent-box">
                                    <div class="search mb-5">
                                        ...
                                        <button type="button"><img src="{{asset('assets/newProfile')}}/images/icons/Search.png" alt="search icon"></button>
                                    </div>
{{--                                    <div class="row">--}}
{{--                                        <div thumbsSlider="" class="swiper teamsSwiper">--}}
{{--                                            <div class="swiper-wrapper">--}}
{{--                                                <div class="swiper-slide">--}}
{{--                                                    <div class="card">--}}
{{--                                                        <img src="images/teams/senior.png" class="mt-2" alt="Senior Management">--}}
{{--                                                        <h6>Senior Management</h6>--}}
{{--                                                        <button type="button" >8 employees</button>--}}
{{--                                                    </div>--}}
{{--                                                </div>--}}
{{--                                                <div class="swiper-slide">--}}
{{--                                                    <div class="card">--}}
