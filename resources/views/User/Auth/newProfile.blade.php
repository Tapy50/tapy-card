...
<head>
    ...
    <link rel="stylesheet" href="{{asset('assets/newPparofile')}}/plyr.css" />
    ...
    <style>
        ...
        .pdf-tabs-container::-webkit-scrollbar-thumb:hover {
                ...
                <div class="parent-container" id="parent-container">
                    <div class="nav-tabs">
                        <ul class="nav nav-pills" id="pills-tab" role="tablist">
                            ...
                            @if(count($data->Payments)>0)
                            <li class="nav-item" role="presentation">
                                <button class="nav-link" id="pdf-tab" data-bs-toggle="pill" data-bs-target="#pills-pdf"
                                        type="button" role="tab" aria-controls="pills-word" aria-selected="false">{{__('lang.PDF')}}</button>
                            </li>
                            @endif
                            @if($data->User->type == 'company')
                            <li class="nav-item" role="presentation">
...
{{--                                        </div>--}}
                        ...
                        <div class="tab-pane fade pdf-content" id="pills-pdf" role="tabpanel" aria-labelledby="pdf-tab">
                            <h3 class="title"> {{__('lang.PDF')}}
                                <span class="caret-left"><i class="fa-solid fa-caret-left"></i></span>
                                <span class="caret-right"><i class="fa-solid fa-caret-right"></i></span>
                            </h3>
                                ...
                                <div class="row">
                                    <div class="pdf-tabs-container">
                                        <div class="nav-tabs-scroll">
                                                <div class="nav-tabs" id="pdf-myTab" role="tablist">
                                                    <div class="nav-item scrollable-nav-item">
                                                        <button class="nav-link active" data-bs-toggle="tab" data-bs-target="" type="button" role="tab" aria-controls="home" aria-selected="true" style="color: black !important">
                                                            All
                                                        </button>
                                                    </div>
                                                    @foreach ($data->PdfCategories as $pdfCategory)
                                                        <div class="nav-item scrollable-nav-item">
                                                            <button class="nav-link" data-bs-toggle="tab" data-bs-target="" type="button" role="tab" aria-controls="home" aria-selected="true" style="color: black !important">
                                                                {{$pdfCategory->category_name}}
                                                            </button>
                                                        </div>
                                                    @endforeach
                                                </div>
                                    ...
                                    <ul class="nav nav-pills my-3 px-4 d-flex justify-content-between align-items-center" id="pills-tab" role="tablist">
                                        ...
                                        @foreach($data->Pdfs as $pdf)
                                            <embed src="{{ asset('uploads/pdf/' . $pdf->name) }}" type="application/pdf" width="100%" height="600px">
                                        @endforeach
                                        </li>
                                        <li class="nav-item" role="presentation">
                                            <button class="nav-link" id="pills-paypal-tab" data-bs-toggle="pill" data-bs-target="#pills-paypal" type="button" role="tab" aria-controls="pills-paypal" aria-selected="false">
