            ...
            <div >
                <div class="card col-lg-4 mx-auto">
                    <div class="card-body py-5">
                        ...
                        <h3 id="headd" class="card-title text-left mb-3">Let's create your account</h3>

                        @if($data->type == 'company')
                        <form id="regForm" class="auth-register-form mt-2" enctype="multipart/form-data" action="{{ url('registerCompany') }}" method="POST">
                         @else
                                <form id="regForm" class="auth-register-form mt-2" enctype="multipart/form-data" action="{{ url('register') }}" method="POST">
                          @endif
                            <div class="tab">
                                @csrf
                                <div class="w-100">
                                    ...
                                    <div class="mb-10 fv-row">
                                        ...
                                        <!--end::Label-->
                                        <!--begin::Input-->
                                        <input type="tel" class="form-control form-control-lg form-control-solid" name="phone" />
                                        <!--end::Input-->
                                    </div>
                                    <!--begin::Input group-->
                                    <div class="mb-10 fv-row">
                                    ...
                                    <div class="mb-10 fv-row">
                                        ...
                                        <!--end::Label-->
                                        <!--begin::Input-->
                                        <select name="lang"  id="lang"  onchange="lang()" class="form-control">
                                    ...
                                    <div style=" margin-left: 1em; ">
                                        <input class="form-check-input" name="mail_aggreement" type="checkbox" id="mail_aggreement" checked tabindex="4" />
                                        <label class="form-check-label  mb-1" for="mail_aggreement">
                                            I agree to join Tapy's mailing list</a>
                                        </label>
                                        <br>

                                        <input class="form-check-input" name="terms_agreement" type="checkbox" required checked id="register-terms_agreement" tabindex="4" />
                                        <label class="form-check-label" id="register-terms_agreementa" for="register-terms_agreement">
                                            I agree to <a href="https://tapycard.com/privacy-policy/" target="_blank">privacy policy</a> & <a href="https://tapycard.com/terms-of-service/" target="_blank">terms</a>
                                        </label>
                                    </div>
                                    <!--end::Input group-->
                                    <!--begin::Input group-->
                                ...
                                <div class="w-100">
                                    ...
                                    @php
                                        ...
                                        // Check if the server name contains 'localhost'
                                        if (strpos($serverName, 'tapy.test') !== false) {
                                            $domainPrefix = 'tapy.test/';
                                        } elseif (strpos($serverName, 'tapy.ae') !== false) {
                                            // Check if the server name contains 'development'
                                            $domainPrefix = 'tapy.ae/';
                                        } elseif (strpos($serverName, 'tapycard.me') !== false) {
                                            // Check if the server name contains 'production'
                                            $domainPrefix = 'tapycard.me/';
                                        }
                                    @endphp
                                    <div class=" mb-7 row">
                                        <!--begin::Label-->
                                        ...
                                        <div class="col-md-6">
                                            <input type="text" name="url"  readonly
                                                   class="form-control form-control-solid mb-3 mb-lg-0"
                                                   placeholder="" value="{{$domainPrefix}}P/" required/>
                                        </div>
                                        <div class="col-md-6">
                            ...
                            <div id="ar">
                                        ...
                                        @if($data->type != 'company')
                                            <div class="col-md-6 d-flex flex-column mb-7 fv-row">
                                                ...
                                                <!--end::Label-->
                                                <input type="text"   class="form-control form-control-solid" placeholder=""   name="ar_first_name"  />
                                            </div>
                                            <!--end::Input group-->
                                            <!--begin::Input group-->
                                            ...
                                            <div class="col-md-6 d-flex flex-column mb-7 fv-row">
                                                ...
                                                <!--end::Label-->
                                                <input type="text"   class="form-control form-control-solid" placeholder=""   name="ar_last_name" value=" " />
                                            </div>
                                            <!--end::Input group-->
                                            <!--begin::Input group-->
                                            ...
                                            <div class="col-md-6 d-flex flex-column mb-7 fv-row">
                                                ...
                                                <!--end::Label-->
                                                <input type="text"   class="form-control form-control-solid" placeholder=""   name="ar_company" value=" " />
                                            </div>
                                            ...
                                            <div class="col-md-6 d-flex flex-column mb-7 fv-row">
                                                ...
                                                <!--end::Label-->
                                                <input type="text"   class="form-control form-control-solid" placeholder=""   name="ar_title" value=" " />
                                            </div>
                                            <!--end::Input group-->
                                            <!--begin::Input group-->
                                            ...
                                            <div class="col-md-6 d-flex flex-column mb-7 fv-row">
                                                ...
                                                <!--end::Label-->
                                                <input type="text"  class="form-control form-control-solid"    name="ar_sub_title" value=" " />
                                            </div>
                                        ...
                                        <div class="d-flex flex-column mb-7 fv-row">
                                            ...
                                            <!--end::Label-->
                                            <textarea rows="5"  id="editor1" class="form-control" name="ar_about"></textarea>
                                        </div>
                                    ...
                                    <div   style="display:none" id="en">
                                        <div class="row mb-10">
                                            ...
                                            <div class="col-md-6 d-flex flex-column mb-7 fv-row">
                                                ...
                                                <div class="position-relative">
                                                    <!--begin::Input-->
                                                    <input type="text"  class="form-control form-control-solid" placeholder="" name="en_first_name"  />
                                                    <!--end::Input-->
                                                    <!--begin::Card logos-->
                                                    <!--end::Card logos-->
                                                </div>
                                            ...
                                            <div class="col-md-6 d-flex flex-column mb-7 fv-row">
                                                ...
                                                <div class="position-relative">
                                                    <!--begin::Input-->
                                                    <input type="text"  class="form-control form-control-solid" placeholder="" name="en_last_name"  />
                                                    <!--end::Input-->
                                                    <!--begin::Card logos-->
                                                    <!--end::Card logos-->
                                                </div>
                                            ...
                                            <div class="col-md-6 d-flex flex-column mb-7 fv-row">
                                                ...
                                                <div class="position-relative">
                                                    <!--begin::Input-->
                                                    <input type="text"  class="form-control form-control-solid" name="en_company"  />
                                                    <!--end::Input-->
                                                    <!--begin::Card logos-->
                                                    <!--end::Card logos-->
                                                </div>
                                            ...
                                            <div class="col-md-6 d-flex flex-column mb-7 fv-row">
                                                ...
                                                <div class="position-relative">
                                                    <!--begin::Input-->
                                                    <input type="text"  class="form-control form-control-solid" placeholder="" name="en_title"  />
                                                    <!--end::Input-->
                                                    <!--begin::Card logos-->
                                                    <!--end::Card logos-->
                                                </div>
                                            ...
                                            <div class="col-md-6 d-flex flex-column mb-7 fv-row">
                                                ...
                                                <div class="position-relative">
                                                    <!--begin::Input-->
                                                    <input type="text"  class="form-control form-control-solid" name="en_sub_title"  />
                                                    <!--end::Input-->
                                                    <!--begin::Card logos-->
                                                    <!--end::Card logos-->
                                                </div>
                                        ...
                                        <div class="d-flex flex-column mb-7 fv-row">
                                            ...
                                            <!--end::Label-->
                                            <textarea rows="5" id="editor2" class="form-control" name="en_about"></textarea>
                                        </div>
                            ...
                            <div style="overflow:auto;">
                                <div id="nxtpr" class="mt-4" style="float:right;margin-top: 10px; width: 100%;">
                                    <button type="button" id="prevBtn" onclick="nextPrev(-1)">Back</button>
                                    <button type="button" id="nextBtn" style="width:100%;    float: right;" onclick="nextPrev(1)">Next</button>
                                </div>
                            </div>
                            <div style="overflow:auto;">
                                <div id="nxtpra" class="mt-4" style="float:right;margin-top: 10px;width: 100%;">
                                    <button type="button" id="skipBtn" style="width:100%;background: black;display:none" onclick="nextPrev(1)">Skip</button>
                                </div>
                            </div>
...
<!-- plugins:js -->
<!--
<script src="/public/assets/ui/assets/vendors/js/vendor.bundle.base.js"></script>
-->
<!-- endinject -->
...
<!-- inject:js -->
<!--
<script src="/public/assets/ui/assets/js/off-canvas.js"></script>
<script src="/public/assets/ui/assets/js/hoverable-collapse.js"></script>
<script src="/public/assets/ui/assets/js/misc.js"></script>
<script src="/public/assets/ui/assets/js/settings.js"></script>
<script src="/public/assets/ui/assets/js/todolist.js"></script>
-->
<!-- endinject -->
...
<script>
    ...
    function showTab(n) {
        ...
        if (n == 1) {
            document.getElementById("nxtpr").style.float = "unset";
            document.getElementById("prevBtn").style.display = "none";
            document.getElementById("nextBtn").innerHTML = "Create Account";
            document.getElementById("skipBtn").style.display = "none";
            document.getElementById("nextBtn").style.width = "100%";
        }else if (n == 2) {
            document.getElementById("headd").innerHTML = "Step 1.<br>Tell us about yourself";
            document.getElementById("prevBtn").style.display = "none";
            document.getElementById("basic-addon3a").innerHTML = "https://profile.tapycard.com/";
            document.getElementById("nextBtn").innerHTML = "Next";
            document.getElementById("skipBtn").style.display = "none";
            document.getElementById("nextBtn").style.width = "unset";
            document.getElementById("nxtpr").style.float = "right";
        }else if (n == 3) {
            document.getElementById("prevBtn").style.display = "inline";
            document.getElementById("headd").innerHTML = "Step 2.<br>Choose your profile link";
            if(document.getElementById("register-last_name")) document.getElementById("fnln").innerHTML = document.getElementById("register-first_name").value+" "+document.getElementById("register-last_name").value;
            else document.getElementById("fnln").innerHTML = document.getElementById("register-first_name").value;
            document.getElementById("register-first_name2").value = document.getElementById("register-first_name").value;
            <?php if($data->type == 2){ ?>document.getElementById("register-last_name2").value = document.getElementById("register-last_name").value;<?php } ?>
            <?php if($data->type     == 4){ ?>document.getElementById("register-last_name2").value = document.getElementById("register-last_name").value;<?php } ?>
            document.getElementById("nextBtn").innerHTML = "Next";
            document.getElementById("skipBtn").style.display = "none";
            document.getElementById("nextBtn").style.width = "unset";
            document.getElementById("nxtpr").style.float = "right";
            ...
            document.getElementById("prevBtn").style.display = "inline";
            document.getElementById("headd").innerHTML = "Step 3.<br>Let's create your digital card";
            document.getElementById("nextBtn").innerHTML = "Next";
            ...
            document.getElementById("prevBtn").style.display = "inline";
            document.getElementById("headd").innerHTML = "Step 4.<br>Add your social accounts";
            document.getElementById("nextBtn").innerHTML = "Next";
            document.getElementById("skipBtn").style.display = "block";
            document.getElementById("nextBtn").style.width = "unset";
            document.getElementById("nxtpr").style.float = "right";
            ...
            document.getElementById("prevBtn").style.display = "inline";
            document.getElementById("headd").innerHTML = "Step 5.<br>Add video to your profile";
            document.getElementById("nextBtn").innerHTML = "Next";
            document.getElementById("skipBtn").style.display = "block";
            document.getElementById("nextBtn").style.width = "unset";
            document.getElementById("nxtpr").style.float = "right";
            ...
            document.getElementById("prevBtn").style.display = "inline";
            document.getElementById("headd").innerHTML = "Step 6.<br>Add Images to your profile";
            document.getElementById("nextBtn").innerHTML = "Next";
            document.getElementById("skipBtn").style.display = "block";
            document.getElementById("nextBtn").style.width = "unset";
            document.getElementById("nxtpr").style.float = "right";
            ...
            document.getElementById("prevBtn").style.display = "inline";
            document.getElementById("headd").innerHTML = "Step 7.<br>Add contact information";
            document.getElementById("nextBtn").innerHTML = "Next";
            document.getElementById("skipBtn").style.display = "block";
            document.getElementById("nextBtn").style.width = "unset";
            document.getElementById("nxtpr").style.float = "right";
            ...
            document.getElementById("prevBtn").style.display = "inline";
            document.getElementById("headd").innerHTML = "Step 8.<br>Add Business Hours";
            document.getElementById("nextBtn").innerHTML = "Next";
            document.getElementById("skipBtn").style.display = "block";
            document.getElementById("nextBtn").style.width = "unset";
            document.getElementById("nxtpr").style.float = "right";
            ...
            document.getElementById("prevBtn").style.display = "inline";
            document.getElementById("headd").innerHTML = "Step 9.<br>Add Appointments";
            document.getElementById("nextBtn").innerHTML = "Create Account";
            document.getElementById("nextBtn").style.width = "unset";
            document.getElementById("nxtpr").style.float = "right";
        }else{
    ...
    function validateForm() {
        ...
        //console.log("Validate: " + currentTab);
        if (/*currentTab == 0 || currentTab == 1 || currentTab == 2 || currentTab == 3 || */currentTab == 4 || currentTab == 5 || currentTab == 6 || currentTab == 7){
            document.getElementsByClassName("step")[currentTab].className += " finish";
            return true; // Dont validate these steps

        }if (currentTab == 8 || currentTab == 9 || currentTab == 10){
            document.getElementsByClassName("step")[currentTab].className += " finish";
            return true; // Dont validate these steps
        }
        ...
        if (currentTab == 1 && document.getElementById("register-terms_agreement").checked == false) {
            document.getElementById("register-terms_agreementa").style.background = "#ff00004d";
            valid = false;
        }
