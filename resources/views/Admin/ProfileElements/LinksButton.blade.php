...
<div class="dt-buttons flex-wrap">
    ...
    <button  data-type="active" class="activeAll2 btn btn-light-primary me-3">
        <i class="bi bi-unlock fs-2x"></i>
    </button>
    <button   data-type="inactive" class="activeAll2 btn btn-light-danger me-3 font-weight-bolder">
                ...
                <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
                    ...
                    <!--begin::Scroll-->
                        <div class="d-flex flex-column scroll-y me-n7 pe-7"
                            ...
                            <input type="hidden" value="links" name="type">
...
<script type="text/javascript">
    ...
    $(".activeAll2").on("click", function () {
        var type = $(this).data('type');
        var dataList = [];
        $("#users_table2 input:checkbox:checked").each(function (index) {
            dataList.push($(this).val())
        })
        if (dataList.length > 0) {
            Swal.fire({
