...
@section('content')
                    ...
                    <table class="table align-middle table-row-dashed fs-4 gy-5" id="users_table">
                        ...
                        <tr class="text-start text-muted fw-bolder fs-5 text-uppercase gs-0">
                            ...
                            @if(Auth::guard('admin')->check())
                                <th class="min-w-125px">{{__('lang.serial')}}</th>
                                <th class="min-w-125px">{{__('lang.code')}}</th>
                                <th class="min-w-125px">{{__('lang.qrcode')}}</th>
                            ...
                            @endif
                                ...
                                <th class="min-w-125px">{{__('lang.user')}}</th>
                                <th class="min-w-125px">{{__('lang.Profile')}}</th>
                                @if(Auth::guard('web')->user()->type != 'solo')
                                <th class="min-w-125px">{{__('lang.departments')}}</th>
                                @endif
                                <th class="min-w-125px">{{__('lang.Actions')}}</th>
    ...
    <div class="modal fade bs-edit-modal-lg" id="modal-body" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel"
        ...
        $(function () {
            var table = $('#users_table').DataTable({
                ...
                columns: [
                    ...
                    {data: 'serial', name: 'serial', "searchable": true, "orderable": true},
                    {data: 'secret', name: 'secret', "searchable": true, "orderable": true},
                    {data: 'qrcode', name: 'qrcode', "searchable": true, "orderable": true},
                    {data: 'type', name: 'type', "searchable": true, "orderable": true},
                    {data: 'user_id', name: 'user_id', "searchable": false, "orderable": true},
                    {data: 'profile_id', name: 'profile_id', "searchable": false, "orderable": true},
