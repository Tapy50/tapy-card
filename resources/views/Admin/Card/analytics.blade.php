    ...
    <div id="kt_header" class="header" data-kt-sticky="true" data-kt-sticky-name="header" data-kt-sticky-offset="{default: '200px', lg: '300px'}">
        ...
        <div class="container-xxl d-flex align-items-center justify-content-between" id="kt_header_container">
            ...
            <div class="page-title d-flex flex-column align-items-start justify-content-center flex-wrap me-lg-2 pb-2 pb-lg-0" data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_header_container', lg: '#kt_header_container'}">
                <!--begin::Heading-->
                <h1 class="text-dark fw-bolder my-0 fs-2"> {{__('lang.Analytics')}}   : {{$data->serial}} </h1>
                <!--end::Heading-->
                <!--begin::Breadcrumb-->
                <ul class="breadcrumb fw-bold fs-base my-1">
                    ...
                    <li class="breadcrumb-item text-muted">
                        <a href="{{url('/Card_setting')}}" class="text-muted">@if(Auth::guard('web')->check() && Auth::guard('web')->user()->type == 'solo')
                                {{__('lang.devices')}}

                            @else
                                {{__('lang.Card_setting')}}
                            @endif
                        </a>
                    </li>
                </ul>
                ...
                <div class="col-xl-4">
                    ...
                    <a class="card bg-body hoverable card-xl-stretch mb-xl-8">
                        ...
                        <div class="card-body">
                            ...
                            <!--end::Svg Icon-->
                            <div class="text-gray-900 fw-bolder fs-2 mb-2 mt-5">{{$data->AppointmentsRelation->count()}}</div>
                ...
                <div class="col-xl-4">
                    ...
                    <a  class="card bg-dark hoverable card-xl-stretch mb-xl-8">
                        ...
                        <div class="card-body">
                            ...
                            <!--end::Svg Icon-->
                            <div class="text-gray-100 fw-bolder fs-2 mb-2 mt-5">{{$data->ExchangeContact->count()}}</div>
                            <div class="fw-bold text-gray-100">{{__('lang.ExchangeContact')}}</div>
                        </div>
                        <!--end::Body-->
                    </a>
                    <!--end::Statistics Widget 5-->
                ...
                <div class="col-xl-4">
                    ...
                    <a class="card bg-warning hoverable card-xl-stretch mb-xl-8">
                        ...
                        <div class="card-body">
                            ...
                            <!--end::Svg Icon-->
                            <div class="text-white fw-bolder fs-2 mb-2 mt-5">{{$data->TappingLog->count()}}</div>
                            <div class="fw-bold text-white">{{__('lang.Tapping')}}</div>
                        </div>
                        <!--end::Body-->
                    </a>
                    <!--end::Statistics Widget 5-->
                ...
                series: [
                    {
                        ...
                        data: [
                            @inject('uses','App\Models\AppointmentsRelation')
                                @for($x=1; $x<=12; $x++)
                                "{{$uses->where('card_id',$data->id)->whereYear('created_at',date('Y'))->where('states','new')->whereMonth('created_at','=',$x)->count()}}",
                            @endfor
                        ]
                    ...
                    },
                    {
                        ...
                        data: [
                            @inject('uses','App\Models\AppointmentsRelation')
                                @for($x=1; $x<=12; $x++)
                                "{{$uses->where('card_id',$data->id)->whereYear('created_at',date('Y'))->where('states','complate')->whereMonth('created_at','=',$x)->count()}}",
                            @endfor
                        ]
                    }
                ],
