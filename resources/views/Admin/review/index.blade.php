    ...
    <div id="kt_header" class="header" data-kt-sticky="true" data-kt-sticky-name="header" data-kt-sticky-offset="{default: '200px', lg: '300px'}">
        ...
        <div class="container-xxl d-flex align-items-center justify-content-between" id="kt_header_container">
            ...
            <div class="page-title d-flex flex-column align-items-start justify-content-center flex-wrap me-lg-2 pb-2 pb-lg-0" data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_header_container', lg: '#kt_header_container'}">
                <!--begin::Heading-->
                <h1 class="text-dark fw-bolder my-0 fs-2">{{__('lang.Reviews')}} </h1>
                <!--end::Heading-->
                <!--begin::Breadcrumb-->
                <ul class="breadcrumb fw-bold fs-base my-1">
                    ...
                    <li class="breadcrumb-item text-muted">{{__('lang.Reviews')}}</li>
                </ul>
                <!--end::Breadcrumb-->
            </div>
            <!--end::Page title=-->
                ...
                <div class="card-body pt-0">
                    ...
                    <table class="table align-middle table-row-dashed fs-4 gy-5" id="users_table">
                        ...
                        <tr class="text-start text-muted fw-bolder fs-5 text-uppercase gs-0">
                            ...
                            <th class="min-w-125px">{{__('lang.rate')}}</th>
                            <th class="min-w-125px">{{__('lang.quality')}}</th>
                            <th class="min-w-125px">{{__('lang.quickness')}}</th>
                            <th class="min-w-125px">{{__('lang.friendliness')}}</th>
                            <th class="min-w-125px">{{__('lang.note')}}</th>
        ...
        $(function () {
            var table = $('#users_table').DataTable({
                ...
                buttons: [
                    ...
                    {extend: 'csv', className: 'btn btn-light-primary me-3', text: 'CSV'},
                    // {extend: 'colvis', className: 'btn secondary', text: 'إظهار / إخفاء الأعمدة '}
                ],
                ajax: {
                    url: '{{ route('review.datatable.data') }}',
                    data: {
                ...
                columns: [
                    ...
                    {data: 'quality', name: 'quality', "searchable": true, "orderable": true},
                    {data: 'quickness', name: 'quickness', "searchable": false, "orderable": false},
                    {data: 'friendliness', name: 'friendliness', "searchable": false, "orderable": false},
